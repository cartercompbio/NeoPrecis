...
class Blosum62():
    ...
    def _ordered(self, matrix,
                 pre_aa_list=['A', 'R', 'N', 'D', 'C', 'Q', 'E', 'G', 'H', 'I', 'L', 'K', 'M', 'F', 'P', 'S', 'T', 'W', 'Y', 'V', 'B', 'Z', 'U', '*'],
                 post_aa_list=['A', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'K', 'L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'V', 'W', 'Y']):
        idx = [pre_aa_list.index(aa) for aa in post_aa_list]
        return matrix[idx,:][:,idx]
        
    def _normalized(self, matrix):
